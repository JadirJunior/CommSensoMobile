...
class _AppShellPageState extends State<AppShellPage> {
  ...
  final _titles = const ['Dispositivos', 'Ao vivo', 'Apps', 'Ajustes'];

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(_titles[index])),
      body: IndexedStack(index: index, children: _pages), // preserva estado das abas
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          ...
          NavigationDestination(icon: Icon(Icons.settings), label: _titles[3]),
        ],
      ),
